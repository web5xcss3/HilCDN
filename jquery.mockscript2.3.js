(function($) {
	...
	// ==================================================================
	// SEARCH SYSTEM (SPA SAFE)
	// ==================================================================

		// HANDLE SEARCH
		function handleSearch() {

			const $searchInput = $('#searchInput'); // sempre atualizado
		...
		function renderSearchDropdown(searchTerm) {
			...
			const results = (originalData.featured || [])
				.filter(item => {
			...
			$dropdown.html(results.map(item => `
